  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate("/");
        window.location.href = "/"; // Force reload to ensure auth state updates
      } else {
            ...
            <form className="space-y-6">
              <div>
                <input
                  ...
                  className="w-full p-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none text-center"
                  maxLength={6}
                />
              </div>
              ...
              <button
                ...
                type="button"
                className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white py-3 rounded-lg font-medium hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 transition-all duration-300 focus:ring-2 focus:ring-purple-500/20 focus:outline-none"
              >
