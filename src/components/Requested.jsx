        ...
        <header className="mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-1 sm:gap-2 w-full sm:w-auto">
              ...
              <select
                className="w-full sm:w-24 bg-gray-700 text-gray-300 border border-gray-700 rounded-md px-1 sm:px-2 py-1.5 sm:py-2 focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-xs sm:text-sm"
                value={itemsPerPage}
